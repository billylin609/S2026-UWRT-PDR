...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/UWRT PDR Balance Sheet.png}
    \caption{
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=1\textwidth]{figures/S26 UWRT Gantt Chart.png}
    \caption{
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Rover System Diagram.png}
    \caption{
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/UWRT Science Architecture 26.png}
    \caption{
        This figure presents the proposed science payload architecture. As the science module development is ongoing, this diagram represents our current preliminary design.
    }
    \label{fig:rover_science_arch}
\end{figure}