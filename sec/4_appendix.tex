...
\begin{figure}[htp]
    ...
    \caption{
        This season, our team has no blocking mechanical tasks since most mechanical design and manufacturing are already complete from last season. We're focusing on limited improvements that are released once fully tested. This figure shows the design timeline for our main systems—drivetrain, arm, science, and comms—with emphasis on redesigning the core architecture for improved performance.
    }
